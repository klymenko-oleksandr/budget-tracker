                                ...
                                <div className="flex border border-slate-300 rounded-md overflow-hidden">
                                    <button
                                        ...
                                        className={`px-3 py-1 text-sm transition-colors ${
                                            chartType === 'pie' ? 'bg-slate-600 text-white' : 'bg-white text-slate-700 hover:bg-slate-50'
                                        }`}
                                    >
                                        🥧 Pie
                                    </button>
                                    <button
                                        ...
                                        className={`px-3 py-1 text-sm transition-colors border-l border-slate-300 ${
                                            chartType === 'bar' ? 'bg-slate-600 text-white' : 'bg-white text-slate-700 hover:bg-slate-50'
                                        }`}
                                    >
                                        📊 Bar
                                    </button>
