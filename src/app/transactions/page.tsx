    ...
    return (
        <div className="p-10 max-w-6xl mx-auto">
            ...
            <div className="space-y-6">
                ...
                {/* Transaction Form */}
                {showForm && <TransactionForm onSuccess={handleTransactionSuccess} onCancel={() => setShowForm(false)} />}
                ...
                {/* Transaction Filters */}
                <TransactionFilters onFiltersChange={handleFiltersChange} onReset={handleFiltersReset} />
