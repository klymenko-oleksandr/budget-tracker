...
export default function CategoriesPage() {
    ...
    return (
        <div className="p-10 space-y-6">
            ...
            {showCreateForm && <CategoryForm mode="create" onSuccess={handleFormSuccess} onCancel={handleFormCancel} />}

            {/* Edit Category Form */}
            {editingCategory && (
                <CategoryForm category={editingCategory} mode="edit" onSuccess={handleFormSuccess} onCancel={handleFormCancel} />
            )}
