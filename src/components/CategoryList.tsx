                    ...
                    <div key={category.id} className="border border-slate-200 rounded-lg p-4 transition-shadow">
                        ...
                        <div className="mb-4">
                            <div className="flex justify-between items-center text-sm">
                                ...
                                <span className="font-medium text-slate-800">{formatCurrency(category.budget)}</span>
                            </div>
                        </div>
                        ...
                        <div className="mt-3 text-xs text-slate-400">Created: {new Date(category.createdAt).toLocaleDateString()}</div>
                    </div>
                ))}
            </div>
