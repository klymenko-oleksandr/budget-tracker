        ...
        <div className="bg-white p-4 rounded-lg border">
            <div className="flex justify-between items-center mb-4">
                <h3 className="text-lg font-semibold text-slate-800 flex items-center">
                    🔍 Filter Transactions
                    {hasActiveFilters() && <span className="ml-2 bg-blue-100 text-blue-800 text-xs px-2 py-1 rounded-full">Active</span>}
                </h3>
                <div className="flex space-x-2">
                    <button onClick={() => setIsExpanded(!isExpanded)} className="text-slate-600 hover:text-slate-800 text-sm">
            ...
            <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <label className="block text-sm font-medium text-slate-700 mb-1">Search Description</label>
                        <input
                            type="text"
                    ...
                    <div className="text-sm text-slate-600">
                        ...
                        <div className="flex flex-wrap gap-2 mt-2">
                            ...
                            {(filters.startDate || filters.endDate) && (
                                <span className="bg-orange-100 text-orange-800 px-2 py-1 rounded-full text-xs">Date Range</span>
                            )}
                            {(filters.minAmount || filters.maxAmount) && (
                                <span className="bg-red-100 text-red-800 px-2 py-1 rounded-full text-xs">Amount Range</span>
                            )}
                        </div>
                    </div>
                </div>
